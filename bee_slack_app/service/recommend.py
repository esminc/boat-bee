...
class RecommendService:
    ...
    def __init__(
        ...
        self.recommend_book_repository = recommend_book_repository

    def recommend(self, user: User) -> list[SearchedBook]:
        """
        おすすめの本の情報を返却する
        ...
        try:
            ...
            isbn_dict = self.recommend_book_repository.fetch(user_id)
...
recommend_service = Injector().get(RecommendService)
