...
class TestBookReview:
    ...
    def test_レビューを取得できること(self):
        ...
        assert reviews[0]["image_url"] == "dummy_url_0"
        ...
        assert reviews[1]["image_url"] == "dummy_url_1"
        ...
        assert reviews[2]["image_url"] == "dummy_url_2"
    ...
    def test_レビューを作成できること(self):
        ...
        assert actual["image_url"] == "dummy_url"
    ...
    def test_他の人へのおすすめ度を指定してレビューを取得できること(self):
        ...
        assert reviews[0]["image_url"] == "dummy_url_1"
        ...
        assert reviews[1]["image_url"] == "dummy_url_2"
    ...
    def test_同じuser_idで別々のisbnの場合_別々のアイテムとして登録すること(self):
        ...
        assert actual_0["image_url"] == "dummy_url_0"
        ...
        assert actual_1["image_url"] == "dummy_url_1"
