...
class Test_get_user:
    def test_ユーザー情報を取得できること(self, monkeypatch):
    ...
    def test_ユーザー情報が無い場合にNoneを返すこと(self, monkeypatch):
        def mock_user_repository_get(_, __):
            return None
    ...
    def test_repositoryの処理でエラーが発生した場合Noneを返すこと(self, monkeypatch):
...
class Test_get_all_user:
    def test_全てのユーザー情報を取得できること(self, monkeypatch):
